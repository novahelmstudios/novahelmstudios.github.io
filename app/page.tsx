                ...
                <nav className="fixed top-16 left-0 w-full z-50 border-emerald-400/20">
                    <div className="max-w-7xl mx-auto px-2 lg:px-8 h-20 flex items-center">
                        ...
                        <a href='/' className="flex-shrink-0">
                            <img src="/logo.png" alt="Novahelm Studios" className="h-52 w-auto" />
                        </a>

                        <div className="flex-1 flex justify-center">
                            <div className="hidden md:flex items-center space-x-12">
                                <a href="/about" className="relative text-emerald-100 hover:text-emerald-300 font-medium tracking-wide transition-all duration-300 group text-lg">
                                    About
                                ...
                                <a href="/projects" className="relative text-emerald-100 hover:text-emerald-300 font-medium tracking-wide transition-all duration-300 group text-lg">
                                    Projects
                                    <div className="absolute -bottom-2 left-0 w-0 h-0.5 bg-gradient-to-r from-emerald-400 to-orange-300 group-hover:w-full transition-all duration-300" />
                                </a>
                                <a href="/studio" className="relative text-emerald-100 hover:text-emerald-300 font-medium tracking-wide transition-all duration-300 group text-lg">
                                    Studio
                                    <div className="absolute -bottom-2 left-0 w-0 h-0.5 bg-gradient-to-r from-emerald-400 to-orange-300 group-hover:w-full transition-all duration-300" />
                                </a>
                            </div>
                    ...
                    <div className="max-w-7xl mx-auto px-6 lg:px-8 w-full">
                        <div className="max-w-4xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-6">
                                <a
                                    href="/studio"
                                    className="group relative inline-flex items-center justify-center px-6 py-3 text-lg font-semibold text-white bg-gradient-to-r from-emerald-500 to-emerald-600 rounded-xl shadow-2xl transition-all duration-300 hover:from-emerald-400 hover:to-emerald-500 hover:shadow-orange-500/45 hover:-translate-y-1"
                                >
